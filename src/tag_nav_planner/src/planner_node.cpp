...
#include <tag_nav_planner/PlanPath.h>
#include <tag_nav_planner/core/astar.h>
#include <tag_nav_planner/core/connectivity_loader.h>
#include <tag_nav_planner/core/graph.h>
#include <tag_nav_planner/core/tag_map_loader.h>
#include <tag_nav_planner/ros/ros_planner_config.h>
...
private:
  ...
  bool planCallback(tag_nav_planner::PlanPath::Request& request,
                    tag_nav_planner::PlanPath::Response& response)
  {
...
{
  ros::init(argc, argv, "tag_nav_planner");
  try
  {
    tag_nav_planner::PlannerNode node;
    ros::spin();
  }
